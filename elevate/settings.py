...
SECRET_KEY = 'django-insecure-+z06aeyv7n7l^8!(fl=q)rd2gr8qniqd&b6zu($&4q1*yn21!i'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True

ALLOWED_HOSTS = ['0.0.0.0', '18.236.130.151:8000']
...
AWS_STORAGE_BUCKET_NAME = 'data-management-flash' # - Enter your S3 bucket name HERE
